...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.0, 41.0, 134.0, 40.0 ],
					"text" : "Based on the standard Max edit modes widget and graphics (modified)"
				}

			}
, 			{
				"box" : 				{
					"bkgndpict" : "BAT-wfmodes.png",
					"bottomvalue" : 1,
					"id" : "obj-11",
					"imagemask" : 1,
					"inactiveimage" : 0,
					"knobpict" : "BAT-wfknob.png",
					"maxclass" : "pictslider",
					"movehorizontal" : 0,
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 22.5, 32.0, 39.0, 76.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.5, 32.0, 39.0, 76.0 ],
					"rightvalue" : 0,
					"topvalue" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 59.5, 164.5, 110.0, 164.5, 110.0, 22.5, 52.0, 22.5 ],
					"source" : [ "obj-15", 1 ]
				}
